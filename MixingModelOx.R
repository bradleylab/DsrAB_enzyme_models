...
MixMod.complete[,5:n] = Mix.alpha*(MixMod.complete$Rso3/MixMod.complete$Rox)*(2/3)*(((12*MixMod.complete[,5:n]-12*MixMod.complete[,5:n]*MixMod.complete$MM.j+6*MixMod.complete$MM.j-6)/(-2*MixMod.complete[,5:n]-MixMod.complete[,5:n]*MixMod.complete$MM.j+MixMod.complete$MM.j+2))-1)
