...
###### Start of program  ###### 
Dsr<-read.table("Afulg_data.txt",header=TRUE)  ##filename "Dsr_data_23Aug.txt" should be include in R home directory
#attach(Dsr)
#names(Dsr)
...
epsilon.T.34 = alpha2epsilon(alphaT.34)
epsilon.T.33 = alpha2epsilon(alphaT.33)
epsilon.T.36 = alpha2epsilon(alphaT.36)
epsilon.red.34 = alpha2epsilon(alpha.red.34)
epsilon.red.33 = alpha2epsilon(alpha.red.33)
epsilon.red.36 = alpha2epsilon(alpha.red.36)
epsilon.ox.34 = alpha2epsilon(alpha.ox.34)
epsilon.ox.33 = alpha2epsilon(alpha.ox.33)
epsilon.ox.36 = alpha2epsilon(alpha.ox.36)


epsilon.T.34.a = alpha2epsilon(alphaT.34.a)
epsilon.T.33.a = alpha2epsilon(alphaT.33.a)
epsilon.T.36.a = alpha2epsilon(alphaT.36.a)
epsilon.red.34.a = alpha2epsilon(alpha.red.34.a)
epsilon.red.33.a = alpha2epsilon(alpha.red.33.a)
epsilon.red.36.a = alpha2epsilon(alpha.red.36.a)
epsilon.ox.34.a = alpha2epsilon(alpha.ox.34.a)
epsilon.ox.33.a = alpha2epsilon(alpha.ox.33.a)
epsilon.ox.36.a = alpha2epsilon(alpha.ox.36.a)
...
write.table(RResults,file="ReliableResults_Afulg.csv",sep=",",row.names=F)
write.table(RResults.a,file="ReliableResultsA_Afulg.csv",sep=",",row.names=F)
write.table(Results,file="AllResults.csv_Afulg",sep=",",row.names=F)
write.table(Results.a,file="AllResultsA.csv_Afulg",sep=",",row.names=F)
