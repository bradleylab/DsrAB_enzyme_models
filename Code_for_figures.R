...
plot(RedPlot.complete[,1],RedPlot.complete[,2],ylim=c(0.490,0.525), xlim=c(0.982,0.992),xlab="alpha.ox",ylab="lambda",pch=16, col=rgb(1,RedPlot.complete$f,RedPlot.complete$f))
