...
plot(OxPlot.complete[,1],OxPlot.complete[,2],ylim=c(0.490,0.525), xlim=c(1.000,1.015),xlab="alpha.ox",ylab="lambda",pch=16, col=rgb(1,OxPlot.complete$f,OxPlot.complete$f))
